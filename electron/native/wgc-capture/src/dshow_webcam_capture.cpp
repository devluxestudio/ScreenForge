...
bool DirectShowWebcamCapture::initialize(
    ...
    if (!succeeded(impl_->graph->AddFilter(impl_->captureFilter.Get(), L"ScreenForge Webcam Source"),
    ...
    if (!succeeded(impl_->graph->AddFilter(impl_->sampleGrabberFilter.Get(), L"ScreenForge Webcam Sample Grabber"),
    ...
    if (!succeeded(impl_->graph->AddFilter(impl_->nullRenderer.Get(), L"ScreenForge Webcam Null Renderer"),
